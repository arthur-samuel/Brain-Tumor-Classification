...
input_type = gr.inputs.File(label="Upload an image to predict the brain tumor type")
output_type = gr.outputs.Textbox(label="Predicted Brain Tumor ")
title = "Brain Tumor Classification"
description = "Upload an MRI scan image to predict the corresponding brain tumor type"
